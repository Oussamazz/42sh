...
/*   Updated: 2021/03/28 13:51:44 by oelazzou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		add_alias_list_to_file(t_alias *alias)
{
	...
	file = open("/Users/oelazzou/Desktop/42sh/.biggyrc", O_WRONLY | O_CREAT | O_TRUNC, 0644);
	if (alias)
	{
		while (alias)
		{
...
void		create_alias_list()
{
	...
	buff = NULL;
    cmp = NULL;
	file = open("/Users/oelazzou/Desktop/42sh/.biggyrc", O_RDONLY | O_CREAT, 0644);
